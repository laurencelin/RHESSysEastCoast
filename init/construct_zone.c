								   ...
								   struct	world_object *world)
{
	...
	/*--------------------------------------------------------------*/
    zone[0].METV_dayl_21ravgNext60 = malloc(sizeof(double)*NUM_fday_Pred); memset(zone[0].METV_dayl_21ravgNext60, 0, sizeof(double)*NUM_fday_Pred);
    zone[0].METV_tmin_21ravgNext60 = malloc(sizeof(double)*NUM_fday_Pred); memset(zone[0].METV_tmin_21ravgNext60, 0, sizeof(double)*NUM_fday_Pred);
    zone[0].METV_vpd_21ravgNext60 = malloc(sizeof(double)*NUM_fday_Pred); memset(zone[0].METV_vpd_21ravgNext60, 0, sizeof(double)*NUM_fday_Pred);
    ...
    zone[0].metv.tmin_21ravg = 3.0;
    zone[0].metv.dayl_21ravg = 38000;
	/*--------------------------------------------------------------*/
