						...
						struct cdayflux_struct* cdf)
{
	...
	cdf->cpool_leaf_gr     = cdf->cpool_to_leafc * g1; // first growth resp. (direct growth path)
	cdf->cpool_froot_gr    = cdf->cpool_to_frootc * g1;
	cdf->transfer_leaf_gr  = cdf->leafc_transfer_to_leafc * g1; //second growth resp. (indirect growth path)
